...
export function WhatsAppButton() {
  return (
    ...
    >
      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[#1DAA61] text-white shadow-lg">
      ...
      <span
        aria-hidden="true"
        className="rounded-full bg-navy px-2.5 py-1 text-xs font-semibold text-on-navy shadow-lg"
      >
        Chat with us
      </span>
